...
😊 Hi, I'm Gao Feng, an Associate Professor at Ocean University of China. I am a Senior Member of the China Computer Federation (CCF), an Outstanding AC of CCF YOCSEF Qingdao, and the Faculty Advisor of the CCF Student Branch at Ocean University of China.

🎯 My primary research interests lie in hyperspectral image processing and artificial intelligence oceanography. My research covers theories and technologies in artificial intelligence, deep learning, computer vision and related fields, with a particular focus on efficient intelligent interpretation of hyperspectral imagery and marine remote sensing data.

📜 I have published more than 100 academic papers in journals and conferences including IEEE TIP, TNNLS, TCYB, TGRS, TIM, GRSL, JSTARS and JARS. I also serve as an Editorial Board Member of the Journal of Applied Remote Sensing.

E-mail: <gaofeng@ouc.edu.cn>


[Weibo](https://www.weibo.com/summitgao) / [Google Scholar](https://scholar.google.com/citations?user=k91CLXQAAAAJ) / [Github](https://github.com/gaofront) / [Zhihu](https://www.zhihu.com/people/gaopursuit) / [海大主页](https://it.ouc.edu.cn/gf)
...
1. H. Luo, **F. Gao\***, J. Dong, L. Qi, "Hierarchical Attention and Parallel Filter Fusion Network for Multi-Source Data Classification," *IEEE Geoscience and Remote Sensing Letters*, 2024. [[PDF](<https://ieeexplore.ieee.org/document/10643609>)][[Code@Github](<https://github.com/summitgao/HAPNet>)]
...
1. M. Wang, **F. Gao\***, J. Dong, H. -C. Li and Q. Du, "Nearest Neighbor-Based Contrastive Learning for Hyperspectral and LiDAR Data Classification," *IEEE Transactions on Geoscience and Remote Sensing*, 2023. \[[PDF](https://ieeexplore.ieee.org/document/10015054)]\[[Code@Github](https://github.com/summitgao/NNCNet)]
1. L. Qi, Z. Chen, **F. Gao\***, J. Dong\*, X. Gao and Q. Du, "Multiview Spatial-Spectral Two-Stream Network for Hyperspectral Image Unmixing," *IEEE Transactions on Geoscience and Remote Sensing*, 2023. \[[PDF](https://ieeexplore.ieee.org/document/10018370)]
...
1. X. Qu, **F. Gao\***, J. Dong, Q. Du and H. -C. Li, "Change Detection in Synthetic Aperture Radar Images Using a Dual-Domain Network," *IEEE Geoscience and Remote Sensing Letters*, 2022. \[[PDF](https://arxiv.org/pdf/2104.06699.pdf)] \[[Code@github](https://github.com/summitgao/SAR%5C_CD%5C_DDNet)] 
1. T. Zhang, **F. Gao\***, J. Dong\* and Q. Du, "Remote Sensing Image Translation via Style-Based Recalibration Module and Improved Style Discriminator," *IEEE Geoscience and Remote Sensing Letters*, 2022. [[PDF](https://ieeexplore.ieee.org/document/9391996)]\[[Code@Github](https://github.com/summitgao/RSIT%5C_SRM%5C_ISD)]
1. J. Wang, **F. Gao\***, J. Dong, S. Zhang and Q. Du, "Change Detection From Synthetic Aperture Radar Images via Graph-Based Knowledge Supplement Network," *IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing*, 2022. \[[PDF](https://ieeexplore.ieee.org/document/9699382)] \[[Code@github](https://github.com/summitgao/SAR%5C_CD%5C_GKSNet)] 
1. J. Wang, **F. Gao***, J. Dong, Q. Du and H. Li, "Change Detection from Synthetic Aperture Radar Images via Dual Path Denoising Network," *IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing*, 2022. \[[PDF](https://ieeexplore.ieee.org/document/9736680)]
1. J. Wang, **F. Gao\***, J. Dong and Q. Du, "Adaptive DropBlock-Enhanced Generative Adversarial Networks for Hyperspectral Image Classification," *IEEE Transactions on Geoscience and Remote Sensing*, 2021. \[[PDF](https://gaopursuit.oss-cn-beijing.aliyuncs.com/pub/tgrs20%5C_adgan%5C_hyperspectral%5C_image%5C_classification.pdf)] \[[Code@github](https://github.com/summitgao/HC%5C_ADGAN)] 
1. Y. Gao, **F. Gao\***, J. Dong and H. -C. Li, "SAR Image Change Detection Based on Multiscale Capsule Network," *IEEE Geoscience and Remote Sensing Letters*, 2021. \[[PDF](https://gaopursuit.oss-cn-beijing.aliyuncs.com/pub/grsl20%5C_SAR%5C_change%5C_detection%5C_capusule%5C_network.pdf)] \[[Code@github](https://github.com/summitgao/SAR%5C_CD%5C_MS%5C_CapsNet)] 
1. Y. Gao, **F. Gao\***, J. Dong, Q. Du and H. -C. Li, "Synthetic Aperture Radar Image Change Detection via Siamese Adaptive Fusion Network," *IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing*, 2021. \[[PDF](https://ieeexplore.ieee.org/document/9576639)]\[[Code@Github](https://github.com/summitgao/SAR%5C_CD%5C_SAFNet)]
