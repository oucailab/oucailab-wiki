...
😊 Hi, I’m Feng Gao, an Associate Professor at the Ocean University of China, Senior Member of the China Computer Federation (CCF), member of the Advisory and Evaluation Committee of the China Society of Image and Graphics, Outstanding AC of CCF YOCSEF Qingdao, and Director of the CCF Ocean University of China Student Chapter. 🏛️ I received my B.S. degree from the School of Software, Chongqing University, in 2008, and my Ph.D. degree from the School of Computer Science, Beihang University, in 2015. In the same year, I joined the School of Computer Science and Technology, Ocean University of China. 🎯 My main research areas are hyperspectral image processing and AI-based oceanography, including the theories and technologies of artificial intelligence, deep learning, and computer vision, with a focus on the efficient and intelligent interpretation of hyperspectral images and ocean remote sensing data. 📜 I have published over 100 academic papers in journals and conferences such as IEEE TIP, TNNLS, TCYB, TGRS, TIM, GRSL, JSTARS, and JARS, with four ESI Highly Cited Papers. I serve as an editorial board member for the Journal of Applied Remote Sensing. 🍀
